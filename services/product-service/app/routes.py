...
from app.models import db, Product, Collection, Note, Accord
...
# List all products with their associated notes and collection
...
def list_products():
    ...
    return jsonify([{
        ...
        'notes': [{'id': note.id, 'name': note.name, 'accord': note.accord.name} for note in product.notes]
